...
module.exports = [
    ...
    // ── Electrical: 24VAC convention vs polarity ──────────
    {
        ...
        answer: false,
        explain: '24V<em>AC</em> alternates — the voltage reverses 60 times a second, so there\'s no fixed positive or negative. <code>R</code> (red, hot) and <code>C</code> (black/blue, common) are <em>panel conventions</em>, not polarity. Common is the leg bonded to ground at the transformer; hot is the switched leg. Cross-wiring won\'t damage equipment, but it breaks the convention every other tech expects and makes future troubleshooting a nightmare. Respect the convention. (24V<em>DC</em> equipment, by contrast, <em>is</em> polarity-sensitive — and there the labels matter literally.)',
