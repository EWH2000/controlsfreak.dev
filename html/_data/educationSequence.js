...
const order = [
    ...
    // commanding-actuators → start-stop-commands; analog-sensing is
    // in-flight on its own lane, so temperature-sensors sits directly
    // after controller-wiring until it merges ──
