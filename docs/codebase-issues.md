...
### 248. `buildAnswerText` joins the correct choice to `explain` with an unconditional `". "`, so most published FAQPage answers carry a double period *(noticed 2026-07-30, the #241 review round — pre-existing and site-wide, not fixed there)*
...
its own #247 — renumbered to 248 when main was merged in, 2026-07-30.)*
